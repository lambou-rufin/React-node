...
const Block: FC<any> & any = ({ className, ...props }) => {
...
const BlockTitle: FC<any> = ({ className, ...props }) => {
  const compClass = classNames({
    'nk-block-title': true,
    [className]: className,
  })
...
const BlockText: FC<any> = ({ className, ...props }) => {
  const compClass = classNames({
    [className]: className,
  })

  return <p className={compClass ? compClass : ''}>{props.children}</p>
}

const BlockHead: FC<any> = ({ className, page, ...props }) => {
  const compClass = classNames({
    'nk-block-head': true,
    'nk-page-head': page,
    [className]: className,
...
const BlockHeadBetween: FC<any> = ({ className, gap, ...props }) => {
  const compClass = classNames({
...
const BlockHeadContent: FC<any> = ({ className, tools, ...props }) => {
  const compClass = classNames({
