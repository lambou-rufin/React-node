...
// line chart
export const ChartLine: FC<any> = ({ data, ...props }) => {
  let setData = data
  ...
  let xGridColorValue =
    typeof setData.xGridColor === 'undefined' ? Colors.gray100 : setData.xGridColor
  let yGridColorValue =
    typeof setData.yGridColor === 'undefined' ? Colors.gray100 : setData.yGridColor
  let xGridBorderColorValue =
    typeof setData.xGridBorderColor === 'undefined' ? Colors.gray100 : setData.xGridBorderColor
  let yGridBorderColorValue =
    typeof setData.yGridBorderColor === 'undefined' ? Colors.gray100 : setData.yGridBorderColor
...
// bar chart
export const ChartBar: FC<any> = ({ data, ...props }) => {
  let setData = data
  let chartLegend = typeof setData.legend === 'undefined' ? false : setData.legend
  let TicksValue = typeof setData.ticksValue === 'undefined' ? false : setData.ticksValue
  let maxTicksLimitValue = setData.maxTicksLimit
  ...
  let barPercentageValue =
    typeof setData.barPercentage === 'undefined' ? 0.4 : setData.barPercentage
  let categoryPercentageValue =
    typeof setData.categoryPercentage === 'undefined' ? 0.5 : setData.categoryPercentage
  let barThicknessValue =
    typeof setData.barThickness === 'undefined' ? 'flex' : setData.barThickness
...
// pie chart
export const ChartPie: FC<any> = ({ data, ...props }) => {
  let setData = data
  let chartLegend = typeof setData.legend === 'undefined' ? false : setData.legend
  return (
    <Pie
...
// doughnut chart
export const ChartDoughnut: FC<any> = ({ data, ...props }) => {
  let setData = data
  let chartLegend = typeof setData.legend === 'undefined' ? false : setData.legend
...
// Polar chart
export const ChartPolar: FC<any> = ({ data, ...props }) => {
  let setData = data
  let chartLegend = typeof setData.legend === 'undefined' ? false : setData.legend
...
// Radar chart
export const ChartRadar: FC<any> = ({ data, ...props }) => {
  let setData = data
  let chartLegend = typeof setData.legend === 'undefined' ? false : setData.legend
  let TicksValue = typeof setData.ticksValue === 'undefined' ? false : setData.ticksValue
  let borderDashValue = setData.borderDash
  ...
  let ticksNumberLabelValue =
    typeof setData.ticksNumberLabel === 'undefined' ? true : setData.ticksNumberLabel
