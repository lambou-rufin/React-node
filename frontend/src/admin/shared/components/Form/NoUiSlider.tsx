...
const NoUiSlider: FC<any> = ({
  ...
  const noUiSliderElem = useRef<any>(null)
  ...
  connectValue =
    connectValue === 'true' || connectValue === 'false' ? JSON.parse(connectValue) : connectValue
  ...
  return <div ref={noUiSliderElem}></div>
}
