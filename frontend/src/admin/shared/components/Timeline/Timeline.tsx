...
const TimelineGroup: FC<any> = ({ className, title, ...props }) => {
  const Classes = classNames({
...
export const TimelineList: FC<any> = ({ ...props }) => {
  return <div className="nk-timeline-list">{props.children}</div>
}

export const TimelineItem: FC<any> = ({ symbol, avatar, variant, ...props }) => {
  return (
    <div className="nk-timeline-item">
      <div className="nk-timeline-item-inner">
        ...
        <div className="nk-timeline-content">{props.children}</div>
      </div>
    </div>
  )
}
