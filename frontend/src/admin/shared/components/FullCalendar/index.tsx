...
const renderEventContent: FC<any> = (eventInfo) => {
...
const Calendar: FC<any> = ({ eventData, addEventForm }) => {
  ...
  const handleEventClick: any = (eventInfo: any) => {
  ...
  const handleDeleteEvent = () => {
    const updatedEvents = events.filter((item: any) => item.id !== selectedEvent.id)
            ...
            <Row className="g-3">
              <Col xs="6">
                ...
                <p className="event-start small">
                  ...
                  {selectedEvent.startTime && ` - ${toTwelve(selectedEvent.startTime)}`}
                </p>
              </Col>
              <Col xs="6">
                ...
                <p className="event-end small">
                  ...
                  {selectedEvent.endTime && ` - ${toTwelve(selectedEvent.endTime)}`}
                </p>
              </Col>
              <Col xs="12">
        ...
        <div className="modal-content">
          <div className="modal-body p-5 text-center">
            ...
            <ul className="d-flex gap g-3 justify-content-center pt-1">
              ...
              <li>
                <Button variant="danger" className="btn-soft" onClick={closeDeleteModal}>
                  Cancel
                </Button>
              </li>
            </ul>
