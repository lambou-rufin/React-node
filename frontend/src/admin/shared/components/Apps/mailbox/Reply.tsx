...
const Reply: FC<any> & any = ({ ...props }) => {
  return <div className="nk-ibx-reply-item nk-reply-item">{props.children}</div>
}

export const ReplyHeader: FC<any> = ({ ...props }) => {
  return (
...
export const ReplyTools: FC<any> = () => {
  return (
    <ul className="nk-reply-tools g-1">
      <li className="attach-msg d-none d-sm-inline-block">
        <Icon name="clip-h"></Icon>
      </li>
      <li className="date-msg d-none d-sm-inline-block">
        <span className="date">14 Jan, 2020</span>
      </li>
...
export const ReplyBody: FC<any> = ({ ...props }) => {
  return (
    <div className="nk-reply-body nk-ibx-reply-body">
      <div className="nk-reply-entry entry wide-md">{props.children}</div>
    </div>
  )
}

export const ReplyHead: FC<any> = () => {
  return (
    <div className="nk-ibx-reply-head">
      <div className="d-flex gap g-2">
        ...
        <ul className="nk-ibx-tags">
          <li>
            <span className="badge text-bg-primary-soft">Important</span>
          </li>
        </ul>
      </div>
