...
const Message: FC<any> & { Actions: React.FC<any> } = ({ className, isYou, isMe, ...props }) => {
  ...
  return (
    <div className={compClass}>
      ...
      <div className="nk-message-content">{props.children}</div>
    </div>
  )
}

export const MessageActions: FC<any> = ({ ...props }) => {
  return (
      ...
      <li>
        <Dropdown>
          <Dropdown.Toggle
            ...
            className="btn btn-icon btn-zoom btn-sm text-light"
          >
