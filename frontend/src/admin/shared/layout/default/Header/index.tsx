...
const QuickNav: React.FC<any> = ({ className, ...props }) => {
...
const QuickNavItem: React.FC<any> = ({ className, ...props }) => {
  const compClass = classNames({
    'd-inline-flex': true,
    [className]: className,
  })
...
const Header: React.FC<{ breadCrumb: any }> = ({ breadCrumb }) => {
  ...
  const navClass = classNames({
    ...
    'navbar-mobile':
      layout.headerTransition || eval(`layout.breaks.${layout.headerCollapse}`) > window.innerWidth,
  })
        ...
        <div className="container-fluid">
          <div className="nk-header-wrap">
            <div className="nk-header-logo">
              ...
              <Menu breadCrumb={breadCrumb} className="ms-1 mt-1" />
              {/* <Logo /> */}
            </div>
            {layout.headerActive && (
            ...
            <div className="nk-header-tools">
              <QuickNav>
                      ...
                      <ul className="dropdown-list gap gy-2">
                        <li>
                          <MediaGroup>
                            ...
                            <MediaAction end>
                              <Button size="lg" variant="zoom" className="btn-icon me-n1">
                ...
                <Dropdown as={QuickNavItem}>
                  <Dropdown.Toggle bsPrefix="dropdown" as={CustomDropdownToggle}>
                  ...
                  <Dropdown.Menu className="dropdown-menu-md" as={CustomDropdownMenu}>
                    ...
                    <div className="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                      <LinkList>
                        ...
                        <LinkListItem href="/public/discover">
                          <Icon name="signout"></Icon>
                          <span>Aller dans la page public</span>
                        </LinkListItem>
                      </LinkList>
                    </div>
                    <div className="dropdown-content dropdown-content-x-lg py-3">
                      <LinkList>
                        <LinkListItem to="/admin/auth/login" state="test">
                          <Icon name="signout"></Icon>
                          <span>Log Out</span>
                        </LinkListItem>
                      </LinkList>
